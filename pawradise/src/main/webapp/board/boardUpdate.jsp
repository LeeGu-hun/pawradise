...
<div id="contentsBox">
	...
	<form:form commandName="board" id="frm">
		<table  class="table">
			<tr>
			<td>글쓴이</td>
			<td><input type="text" name="writer" size="10" maxlength="10"  class="form-control" value="${sessionScope.authInfo.name}" readonly/>
			</td>
			</tr>		
			<tr>
			<td>제목</td>
			<td><input type="text" path="subject" name="subject" value="${board.subject}" size="50" maxlength="100"  class="form-control"/>
				<br><form:errors path="subject" /></td>
			</tr>	
			<tr>
			<td>내용</td>
