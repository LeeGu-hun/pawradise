 ...
 <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <footer id="footer">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6 margin30">
                        <div class="footer-col">
                            <h3>Pawradise</h3>
                            <p>파우라다이스는 생명을 소중하게 생각합니다. 모든 생명은 가치가 있고 그에 맞는 대우를 받을 권리가 있습니다. 인간과 동물이 모두 잘 사는 세상을 꿈꾸는 발바닥천국입니다.</p>
        ...
        <!--image loads plugin -->
        <script src="<%=request.getContextPath() %>/js/jquery.imagesloaded.min.js" type="text/javascript"></script>
        <!--owl carousel slider-->
