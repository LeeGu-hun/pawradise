...
<title>파우라다이스</title>
  <!-- 공통CSS 인클루드부분  -->
        ...
        <link href="<%=request.getContextPath() %>/css/rev-style.css" rel="stylesheet" type="text/css" media="screen">
        <!--owl carousel css-->
        <link href="<%=request.getContextPath() %>/owl-carousel/assets/owl.carousel.css" rel="stylesheet" type="text/css" media="screen">
        <link href="<%=request.getContextPath() %>/owl-carousel/assets/owl.theme.default.css" rel="stylesheet" type="text/css" media="screen">
        <!--mega menu -->
        ...
        <!-- custom css-->
        <link href="<%=request.getContextPath() %>/css/style.css?ver=11" rel="stylesheet" type="text/css" media="screen">
